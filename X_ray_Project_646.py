# -*- coding: utf-8 -*-
"""
Created on Wed Oct  7 11:44:01 2020
...
def label_img(img): 
	...
	elif word_label == 'COVID-19*': return [0, 1] 
###
...
for num, data in enumerate(test_data[:338]): 
	# positive: [1, 0] 
	# negative: [0, 1] 
	...
	if np.argmax(model_out) == 1: str_label ='positive'
	else: str_label ='negative'
